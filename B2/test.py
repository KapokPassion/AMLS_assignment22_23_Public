...
def self_dataset():
    ...
    model_test = torch.load(r'B2\b2model.pkl', map_location='cpu')
    model_test.eval()
    ...
    dataframe = pd.read_csv(r'Datasets\cartoon_set_test\labels.csv', sep='	')
    test_dataset = EyeDataset(imgs_dir=r'Datasets\cartoon_set_test\img', dataframe=dataframe, transform=trans)
